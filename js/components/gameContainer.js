    ...
    return (
      <div>
        ...
        <div class="gamePlayOptions mt-3">
          <div class="row">
            <div class="col text-muted rtl mb-1">انداره Grid</div>
          </div>
          <div class="row no-gutters mb-2">
            ...
            <div class="col-auto">
              <button
                ...
                id="btn-shoot"
                class={`btn btn-${
                  this.state.arrows ? "primary" : "secondary disabled"
                } btn-sm ${
                  this.state.arrowState ===
                  WumpusManager.constants.arrowState.armed
                    ? "active"
                    : ""
                }`}
                data-toggle="button"
              ...
              >
                ...
                تیر{" "}
                <span class="badge badge-light ml-1 mr-0">
                  {this.state.arrows}
                </span>
              </button>
            </div>
          ...
          <div id="knowledgebase" class="row no-guggers">
            <div class="col-auto">
              <div class="panel panel-default">
                <div
                  class="panel-heading collapsed rtl"
                  data-toggle="collapse"
                  data-target="#knowledgebaseContainer"
                >
                  <i class="fa fa-chevron fa-fw "></i> دانش AI
                </div>
